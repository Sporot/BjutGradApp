...
public class Activity_t5search extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        t5_department=(TextView)findViewById(R.id.t4_department);
        t5_major=(TextView)findViewById(R.id.t4_major);
        t5_studentname=(TextView)findViewById(R.id.t4_studentname);
        t5_teachername=(TextView)findViewById(R.id.t4_teachername);
        t5_type=(TextView)findViewById(R.id.t4_type);
        t5_place=(TextView)findViewById(R.id.t4_place);
        t5_time=(TextView)findViewById(R.id.t4_time);
        t5_experts=(TextView)findViewById(R.id.t4_experts);

        t5_score1=(TextView)findViewById(R.id.t4_score1);
        t5_comment1=(TextView)findViewById(R.id.t4_comment1);
        t5_comment2=(TextView)findViewById(R.id.t4_comment2);
