...
import p.sby.gs_qca.table4.Fragment.t4CommentsFragment;
import p.sby.gs_qca.table4.Fragment.t4ScoreFragment;
...
public class Activity_t4score extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t4_main);

        Toolbar toolbar = (Toolbar) findViewById(R.id.t4_main_toolbar);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.tb2_preview) {
           Intent intent =new Intent(Activity_t4score.this,Activity_t4preview.class);
           ...
           startActivity(intent);
            ...
            if (sendfrom.equals("basic"))
            {
                Log.i("t4save", "onOptionsItemSelected: "+sendfrom);
                save2draft(flagsave);
            }

            else if (sendfrom.equals("drafts")){
                Log.i("t4modify", "enter into modifydraft ");
            ...
            if (!EasyPermissions.hasPermissions(Activity_t4score.this, perms)) {
                EasyPermissions.requestPermissions(Activity_t4score.this, "需要访问手机存储权限！", 10086, perms);
            } else {
                FileDisplayActivity.show(Activity_t4score.this, filePath);
            }
        }
    ...
    private void save2draft(int flagsave) {
        ...
        Thread saveRunnable = new Thread() {
            public void run() {
                ...
                global_variance mysession=(global_variance)(Activity_t4score.this.getApplication());
                ...
                try {
                    ...
                    if(result.equals("100")){
                        Activity_t4score.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toasty.success(Activity_t4score.this,"成功保存到草稿箱！",Toasty.LENGTH_SHORT).show();
                                startActivity(new Intent(Activity_t4score.this,Activity_list.class));
                            }
                        });
                    }
                ...
                try {
                    ...
                    if(result.equals("100")){
                        Activity_t4score.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toasty.success(Activity_t4score.this,"成功修改草稿！",Toasty.LENGTH_SHORT).show();
                                startActivity(new Intent(Activity_t4score.this,Activity_list.class));
                            }
                        });
                    }
    ...
    public void showLoading () {
        if (mLoadingDialog == null) {
            mLoadingDialog = new LoadingDialog(Activity_t4score.this, getString(R.string.loading), false);
        }
        mLoadingDialog.show();
    }
