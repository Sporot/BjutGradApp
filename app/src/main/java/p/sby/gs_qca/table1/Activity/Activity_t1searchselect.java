...
public class Activity_t1searchselect extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        //设置适配器
        adapter = new SearchListAdapter(Activity_t1searchselect.this, datas);
        select_list_view.setAdapter(adapter);

        //设置layoutmanager
        select_list_view.setLayoutManager(new LinearLayoutManager(Activity_t1searchselect.this, LinearLayoutManager.VERTICAL, false));

        //添加分割线
        select_list_view.addItemDecoration(new DividerListItemDecoration(Activity_t1searchselect.this, DividerListItemDecoration.VERTICAL_LIST));
        ...
        adapter.setOnItemClickListener(new TableListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, String content) {
                String id = content;
                if (content == "按学院查询"){
                    startActivity(new Intent(Activity_t1searchselect.this, Activity_t1basicinfo_dep.class));
                }

                if (content == "按教师查询"){
                    startActivity(new Intent(Activity_t1searchselect.this, Activity_t1basicinfo_teacher.class));
                }
            }
        });
