...
public class Activity_searcht4 extends AppCompatActivity {
    ...
    private String temp;
    private String url="http://116.213.144.72:9817/mobile/form/zqkh/userlist.ht";
    private String searchurl="http://116.213.144.72:9817/mobile/form/zqkh/get.ht";
...
//        adapter = new Searcht1Adapter(Activity_searcht1.this,mInventories); //旧版本的Adapter
        adapter=new T1searchAdapter(Activity_searcht4.this,mInventories);
        recyclerView.setAdapter(adapter);

        //设置Layoutmanager
        recyclerView.setLayoutManager(new LinearLayoutManager(Activity_searcht4.this, LinearLayoutManager.VERTICAL, false));

        //添加Recyclerview的分割线
        recyclerView.addItemDecoration(new DividerListItemDecoration(Activity_searcht4.this, DividerListItemDecoration.VERTICAL_LIST));
        ...
        adapter.setOnItemClickListener(new T1searchAdapter.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView.Adapter adapter, View v, int position) {
                ...
                Thread getSearchdetailRunnable = new Thread() {
                    public void run() {
                        ...
                        try {
                            ...
                            JSONObject Searchinfo=new JSONObject(Searchdata.get("ZqkhInfo").toString());
                            JSONObject Searchinfoplus=new JSONObject(Searchdata.get("ZqkhInfoPlus").toString());
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(Activity_searcht4.this, Activity_t4preview.class);
        ...
        Thread searchListRunnable = new Thread() {
            public void run() {
                ...
                try {
                    ...
                    JSONArray draftlist=new JSONArray(Search.get("ZqkhInfo").toString());
